...
import org.wonderdb.wonderdbjdbcdriver.WonderDBConnection.WireData;
import org.wonderdb.wonderdbjdbcdriver.WonderDBResultSetMetadata.ResultSetColumn;
...
public class WonderDBPreparedStatement implements PreparedStatement {
	...
	public ResultSet executeQuery(ChannelBuffer buf) throws SQLException {
        ...
        List<ResultSetColumn> list = new ArrayList<ResultSetColumn>();
